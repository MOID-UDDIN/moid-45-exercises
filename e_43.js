...
var magicianNames2 = ["Salman", "Rauf", "Kashif", "Babar"];
// making a copy of an array
var magicianNames2Copy = __spreadArray([], magicianNames2, true);
function show_magicians(greet) {
    var withGreetings = "";
    for (var _i = 0, magicianNames2Copy_1 = magicianNames2Copy; _i < magicianNames2Copy_1.length; _i++) {
        var magicianName = magicianNames2Copy_1[_i];
        withGreetings += "".concat(greet, " ").concat(magicianName, "\n");
    }
